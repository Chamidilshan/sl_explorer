...
class DayTripListPage_WestCoast extends StatefulWidget {
  final String categoryName;
  const DayTripListPage_WestCoast({Key? key, required this.categoryName}) : super(key: key);

  @override
  State<DayTripListPage_WestCoast> createState() => _DayTripListPageState();
}

class _DayTripListPageState extends State<DayTripListPage_WestCoast>
