...
import 'package:SL_Explorer/features/home/cruise_ships/rooms_count_selection.dart';
...
class CruiseShipsDetailsPage extends StatefulWidget {
  final CruiseShip cruiseShip;
  const CruiseShipsDetailsPage({
    super.key,
    required this.cruiseShip
  });

  @override
  State<CruiseShipsDetailsPage> createState() => _CruiseShipsDetailsPageState();
}

class _CruiseShipsDetailsPageState extends State<CruiseShipsDetailsPage> {
  ...
  // String selectedImage = widget.cruiseShip.hotels[0].hotel.;
  ...
  double calculateRoomPrice(String roomType, int roomCount) {
    ...
    switch (roomType) {
      case 'Single':
        roomPrice = widget.cruiseShip.prices.private.single.toDouble();
        break;
      case 'Double':
        roomPrice = widget.cruiseShip.prices.private.double.toDouble();
        break;
      case 'Triple':
        roomPrice = widget.cruiseShip.prices.private.triple.toDouble();
        break;
  ...
  loadHotelValues(){
    selectedHotelName = widget.cruiseShip.hotels[0].hotel.hotelName.toString();
    selectedRoomDescription = widget.cruiseShip.hotels[0].hotelRoomDesc.toString();
    selectedLocationDescription = widget.cruiseShip.hotels[0].hotelLocationDesc.toString();
  }
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                background: CarouselSlider(
                  ...
                  items: widget.cruiseShip.packageImageLinks.map<Widget>((item) {
                    return Builder(
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${widget.cruiseShip.packageTitle} | ${widget.cruiseShip.packageSubTitle}',
                        style: GoogleFonts.poppins(
                      ...
                      Text(
                        widget.cruiseShip.packageCoverDescription,
                        style: GoogleFonts.poppins(
                  ...
                  children: [
                    SingleChildScrollView(
                      ...
                      child: Row(
                        ...
                        children: [
                          for (var itineraryDay in widget.cruiseShip.itenary)
                            RoundedButton(
                    ...
                    Padding(
                      ...
                      child: Text(
                        widget.cruiseShip.itenary[index].description,
                        style: GoogleFonts.poppins(
                            fontSize: 14.0,
                  ...
                  children: [
                    SingleChildScrollView(
                      ...
                      child: Row(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: widget.cruiseShip.hotels.map((hotel) {
                                        ...
                                        children: [
                                          ...
                                          ElevatedButton(
                                            onPressed: () async{
                                              ...
                                              Map<String, String> packageId = {'cruiseShip': widget.cruiseShip.id.toString()};
